...
cd ~/workspace/common
# cudnn 8.2.4
git clone -b cudnn8.2.4_cuda11.4-gcc8 --depth 1 git@code.byted.org:cpp3rdlib/cudnn.git

# tensorrt 8.2.3
git clone -b TensorRT-8.2.3.0.Linux.x86_64-gnu.cuda-11.4.cudnn8.2-cpp3rdlib --depth 1 git@code.byted.org:cpp3rdlib/tensorrt.git
...
# CUDA path
/usr/local/cuda-11.4,/data00/home/son.nguyen/workspace/common/cudnn,/data00/home/son.nguyen/workspace/common/tensorrt
...
build --action_env TF_CUDA_PATHS="/usr/local/cuda-11.4,/data00/home/son.nguyen/workspace/common/cudnn,/data00/home/son.nguyen/workspace/common/tensorrt"
