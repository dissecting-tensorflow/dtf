...
int main(int argc, char** argv) {
  ...
  // Model graph file
  std::string graphFile = "models/test/test_model_v1/test.pb";
  ...
  std::string name = "fc_hlm_bucket_embedding:0";
  int batch_size = 2;
  int element_size = 10;
  ...
  LOG_INFO("\nFetch name: split:0\n");
  fetches.push_back("split:0");
  LOG_INFO("\nFetch name: longseq_attn_softsearch/mul_18:0\n");
  fetches.push_back("longseq_attn_softsearch/mul_18:0");
